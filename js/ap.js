...
var allModels = [{modelName: 'The Hexawing', modelURL: 'models/hexawing.jpg', difficulty: 5.5, tags: ['Air', 'Future vehicle'], description: 'With its hexagon-shaped wings, this could glide through the air and land smoothly as well.', webLink: '/hexawing', time: 'TBD'}, 
{modelName: 'Fighter jet', modelURL: 'https://3358nc4e1je93h11tu493nryr3i-wpengine.netdna-ssl.com/wp-content/uploads/2019/12/image-coming-soon.jpg', difficulty: 7, tags: ['Air', 'Future vehicle', 'Attacker'], description: 'A normal-looking jet, but it could drop bombs from the center and the side of its wings.', webLink: '/fighter-jet', time: 'TBD'}];
